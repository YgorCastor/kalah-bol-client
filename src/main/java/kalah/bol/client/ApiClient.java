...
import kalah.bol.client.auth.Authentication;
import kalah.bol.client.auth.HttpBasicAuth;
import kalah.bol.client.auth.HttpBearerAuth;
import kalah.bol.client.auth.ApiKeyAuth;
